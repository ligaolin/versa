...
INSERT INTO `admin_cate` VALUES (1,0,1,'系统设置','分类','','','Setting',100,'开启','是',NULL),(2,1,2,'后台栏目','页面','setting/adminCate/index','../views/setting/adminCate/index.vue','',100,'开启','是',NULL),(3,0,1,'角色管理','分类','','','User',100,'开启','是',NULL),(4,3,2,'管理员','页面','role/admin/index','../views/role/admin/index.vue','',100,'开启','是',NULL),(5,3,2,'管理员组','页面','role/group/index','../views/role/group/index.vue','',100,'开启','是',NULL),(6,3,2,'权限','页面','role/auth/index','../views/role/auth/index.vue','',100,'开启','是',NULL),(7,1,2,'数据表','页面','setting/table/index','../views/setting/table/index.vue','',100,'开启','是',NULL),(8,7,3,'数据表字段','页面','setting/table/field','../views/setting/table/field.vue',NULL,100,'开启','否',13),(9,1,2,'系统配置','页面','setting/config/index','../views/setting/config/index.vue','',99,'开启','是',0);
...
INSERT INTO `user` VALUES (1,1,'管理员','admin','$2y$10$4vGK0H44LOiLanBkodhw8ejnBWhAYWy8DGFI4yd0anOsJWVfdop5S','[{\"mime\":\"image\\/jpeg\",\"size\":207443,\"extension\":\"jpg\",\"name\":\"R-C.jpg\",\"type\":\"image\",\"path\":\"\\/static\\/image\\/2023-10-25\\/R-C.jpg\",\"url\":\"http:\\/\\/127.0.0.1:8000\\/static\\/image\\/2023-10-25\\/R-C.jpg\"}]',0,'开启','2023-10-10 06:14:16','2023-10-25 09:30:16'),(2,1,'管理员','gmood','$2y$10$sremc2em3WNcN/0xOjApeOHqi80B2EdAqkqCAHWjAzvD/BJCAR9AK','',100,'开启','2023-10-24 22:03:50','2023-10-26 07:27:16');
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='用户权限';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_auth` VALUES (1,0,2,'系统设置','',100,'开启','管理员'),(2,1,3,'系统配置','',100,'开启','管理员'),(3,1,3,'后台栏目','',100,'开启','管理员'),(4,1,3,'数据表','',100,'开启','管理员'),(5,1,3,'数据表字段','',100,'开启','管理员'),(6,0,1,'角色管理','',100,'开启','管理员'),(7,6,2,'管理员','',100,'开启','管理员'),(8,6,2,'管理员组','',100,'开启','管理员'),(9,6,2,'权限','',100,'开启','管理员'),(10,0,1,'其他','',100,'开启','管理员'),(11,2,4,'查看','admin/setting.Config/List',100,'开启','管理员'),(12,2,4,'获取','admin/setting.Config/Get',100,'开启','管理员'),(13,2,4,'添加','admin/setting.Config/Edit',100,'开启','管理员'),(14,2,4,'修改','admin/setting.Config/Change',100,'开启','管理员'),(15,2,4,'删除','admin/setting.Config/Del',100,'开启','管理员'),(16,3,4,'查看','admin/setting.AdminCate/List',100,'开启','管理员'),(17,3,4,'获取','admin/setting.AdminCate/Get',100,'开启','管理员'),(18,3,4,'编辑','admin/setting.AdminCate/Edit',100,'开启','管理员'),(19,3,4,'修改','admin/setting.AdminCate/Change',100,'开启','管理员'),(20,3,4,'删除','admin/setting.AdminCate/Del',100,'开启','管理员'),(21,2,4,'提交所有修改','admin/setting.Config/ForEditVal',100,'开启','管理员'),(22,4,4,'查看','admin/db.Table/List',100,'开启','管理员'),(23,4,4,'备份','admin/db.Table/Backups',100,'开启','管理员'),(24,4,4,'编辑','admin/db.Table/Edit',100,'开启','管理员'),(25,4,4,'添加','admin/db.Table/Add',100,'开启','管理员'),(26,4,4,'删除','admin/db.Table/Del',100,'开启','管理员'),(27,5,4,'查看','admin/db.Field/List',100,'开启','管理员'),(28,5,4,'编辑','admin/db.Field/Edit',100,'开启','管理员'),(29,5,4,'添加','admin/db.Field/Add',100,'开启','管理员'),(30,5,4,'删除','admin/db.Field/Del',100,'开启','管理员'),(31,7,4,'查看','admin/user.User/List',100,'开启','管理员'),(32,7,4,'获取','admin/user.User/Get',100,'开启','管理员'),(33,7,4,'编辑','admin/user.User/AdminEdit',100,'开启','管理员'),(34,7,4,'修改','admin/user.User/AdminChange',100,'开启','管理员'),(35,7,4,'删除','admin/user.User/AdminDel',100,'开启','管理员'),(36,8,4,'查看','admin/user.UserGroup/List',100,'开启','管理员'),(37,8,4,'获取','admin/user.UserGroup/Get',100,'开启','管理员'),(38,8,4,'编辑','admin/user.UserGroup/AdminEdit',100,'开启','管理员'),(39,8,4,'修改','admin/user.UserGroup/AdminChange',100,'开启','管理员'),(40,8,4,'删除','admin/user.UserGroup/AdminDel',100,'开启','管理员'),(41,8,4,'获取权限','admin/user.UserAuth/GetListByPid',100,'开启','管理员'),(42,9,4,'查看','admin/user.UserAuth/List',100,'开启','管理员'),(43,9,4,'获取','admin/user.UserAuth/Get',100,'开启','管理员'),(44,9,4,'编辑','admin/user.UserAuth/AdminEdit',100,'开启','管理员'),(45,9,4,'修改','admin/user.UserAuth/AdminChange',100,'开启','管理员'),(46,9,4,'删除','admin/user.UserAuth/AdminDel',100,'开启','管理员');
...
-- Dump completed on 2023-10-26 15:59:05
